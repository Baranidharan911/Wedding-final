...
import sty from "./PlasmicDrawer2.module.css"; // plasmic-import: FMwXXyV406MS/css
...
function PlasmicDrawer2__RenderFunc(props) {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_24FvRDn-OPkJ"]]: true })}
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__mkAHb)}
              >
                <div
                  className={classNames(
                    projectcss.all,
