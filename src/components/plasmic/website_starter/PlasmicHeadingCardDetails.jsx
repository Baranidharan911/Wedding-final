...
import sty from "./PlasmicHeadingCardDetails.module.css"; // plasmic-import: q9NG312BRqx6/css
...
function PlasmicHeadingCardDetails__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__atFVz)}>
        <div
          className={classNames(
            projectcss.all,
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__pOcuA)}
        >
          <AntdRate
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__n8F1N)}
      >
        <div
          className={classNames(
            projectcss.all,
