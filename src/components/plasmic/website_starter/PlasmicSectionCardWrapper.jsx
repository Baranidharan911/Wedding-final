...
import sty from "./PlasmicSectionCardWrapper.module.css"; // plasmic-import: 3GsrJjBEX6WY/css
    ...
    >
      ...
      >
        ...
        <SectionWrapperButton
          ...
          className={classNames(
            "__wab_instance",
            sty.sectionWrapperButton__pEacY,
            {
              [sty.sectionWrapperButtonnoButton__pEacY2FInA]: hasVariant(
                $state,
                "noButton",
                "noButton"
              )
        ...
        {renderPlasmicSlot({
          defaultContents: (
            <Stack__
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox___2SE)}
            >
              <Reveal
                children={null}
                className={classNames("__wab_instance", sty.reveal__kB5B)}
                triggerOnce={true}
              />
            </Stack__>
          ),
      ...
      {(hasVariant(globalVariants, "screen", "mobileOnly") ? true : false) ? (
        <SectionWrapperButton
          className={classNames(
            "__wab_instance",
            sty.sectionWrapperButton__x9CvZ
          )}
        />
      ) : null}
    </section>
