...
import sty from "./PlasmicVendorCateogiesCard.module.css"; // plasmic-import: BFcFglg7GpOz/css
...
function PlasmicVendorCateogiesCard__RenderFunc(props) {
  ...
  return (
    <Stack__
      ...
      platform={"react"}
    >
      <div className={classNames(projectcss.all, sty.freeBox___1ZoM0)}>
        <PlasmicImg__
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__psTSo)}
      >
        <div
          className={classNames(
            projectcss.all,
