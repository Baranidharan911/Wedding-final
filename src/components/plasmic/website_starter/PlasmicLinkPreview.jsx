...
import sty from "./PlasmicLinkPreview.module.css"; // plasmic-import: e69h1r_2wGa9/css
...
function PlasmicLinkPreview__RenderFunc(props) {
  ...
  return (
    ...
    >
      <DataCtxReader__>
        {$ctx => (
          <div className={classNames(projectcss.all, sty.freeBox__aECqt)}>
            <PlasmicImg__
            ...
            <div className={classNames(projectcss.all, sty.freeBox___1GNx)}>
              <div className={classNames(projectcss.all, sty.freeBox__gIem5)}>
                <h5
