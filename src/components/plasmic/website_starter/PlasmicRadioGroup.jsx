...
import Label from "../../Label"; // plasmic-import: c8hNq-zJ9ew-/component
import Radio from "../../Radio"; // plasmic-import: 4-EMMVT8uIDV/component
import Description from "../../Description"; // plasmic-import: pQxePYs98rIk/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: AIJRh4XaLtHH/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__n514L)}
          >
            <Radio
              className={classNames("__wab_instance", sty.radio__g8X37)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__mWkbZ)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio___2FVYp)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
