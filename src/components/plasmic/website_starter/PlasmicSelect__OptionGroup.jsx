...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: _nT0iZmfLEdc/css
import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: Qxrry2wyoobC/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__ejgHg)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__ethBr)}
              />
            </React.Fragment>
          ),
