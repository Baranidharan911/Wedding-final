...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: 4-EMMVT8uIDV/css
...
function PlasmicRadio__RenderFunc(props) {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox___35AT5)}>
        <div className={classNames(projectcss.all, sty.freeBox__zAf7V)} />
      </div>
      {renderPlasmicSlot({
