...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: leRyjw1OHU5j/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__m8Utb)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__iogWg)}
              role={"img"}
            />
          ),
